 ...
 * PosOrderReturn
 *
 * @ORM\Table(name="pos_order_return", indexes={@ORM\Index(name="order_return_customer", columns={"id_customer"}), @ORM\Index(name="id_order", columns={"id_order"})})
 * @ORM\Entity
 */
class PosOrderReturn
{
    /**
     * @var int
     *
